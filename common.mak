...
# $(OPENCVINCLUDE) $(MYSQLINCLUDE) add by wcc
CFLAGS := -DHAVE_AV_CONFIG_H -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE \
          -I$(BUILD_ROOT_REL) -I$(SRC_PATH) $(OPENCVINCLUDE) $(MYSQLINCLUDE) $(OPTFLAGS)
...
# $(OPENCVLIBS) add by wcc
FFLDFLAGS   := $(addprefix -L$(BUILD_ROOT)/lib,$(FFLIBS)) $(OPENCVLIBS) $(MYSQLLIBS) $(LDFLAGS)
